...
import LOCKTokenJson from "../clean_build/contracts/LockToken.json";
import KeyMasterJson from "../clean_build/contracts/KeyMaster.json";
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.lockToken = new this.web3.eth.Contract(LOCKTokenJson.abi);
    this.keyMaster = new this.web3.eth.Contract(KeyMasterJson.abi);
  ...
  setProvider(provider, networkId) {
    ...
    const contracts = [
      ...
      { contract: this.lockToken, json: LOCKTokenJson },
      { contract: this.keyMaster, json: KeyMasterJson },
